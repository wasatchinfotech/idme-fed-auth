...
class AuthBackend(ModelBackend):
    ...
    def filter_users_by_claims(self, emailData):
    ...
    def create_user(self, emailData):
    ...
    def get_or_create_user(self, access_token, id_token, payload):
        ...
        users = self.filter_users_by_claims(authenticated_user_email)
        ...
        if len(users) == 1:
            ...
            user = self.create_user(authenticated_user_email)
            return user
        else:
            LOGGER.debug(
